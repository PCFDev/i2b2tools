...
$DEFAULT_DB_SERVER="pcfsqli2b2.pcf.wustl.edu"
...
$DEFAULT_DB_ADMIN_USER="tester" #<== THIS IS NOT SET
...
$CRC_DB_DATASOURCE="java:/QueryToolDS"
...
$SHRINE_DB_DATASOURCE="java:/ShrineOntologyDS"
